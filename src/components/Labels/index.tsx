...
import { getTokenName, AddressToToken, KnownTokenMap } from "../../utils/utils";
...
export const generateActionLabel = (
  ...
  return !connected
    ...
    ? ENTER_AMOUNT_LABEL
    : !A.sufficientBalance()
    ? INSUFFICIENT_FUNDS_LABEL(getTokenName(AddressToToken.get(env) as KnownTokenMap, A.mintAddress))
    : ignoreToBalance || B.sufficientBalance()
    ? action
    : INSUFFICIENT_FUNDS_LABEL(getTokenName(AddressToToken.get(env) as KnownTokenMap, B.mintAddress));
};
